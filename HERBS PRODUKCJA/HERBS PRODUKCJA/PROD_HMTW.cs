...
namespace HERBS_PRODUKCJA
{
    ...
    public partial class PROD_HMTW
    {
        ...
        public Nullable<int> subtypi { get; set; }
        public Nullable<int> znaczniki { get; set; }
        ...
        public Nullable<int> vatspi { get; set; }
        ...
        public string numer_gtin { get; set; }
        public Nullable<byte> czy_opakowanie { get; set; }
        public Nullable<int> id_rodzaj_opakowania { get; set; }
